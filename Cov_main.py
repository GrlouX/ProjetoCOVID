...
# Linhas válidas do código principal: 80
# Comandos da linguagem (6): "print(str)", "input(str)", "append(list)", "range(num_ini,num_fin)", "len(list)", "exit".
# Estruturas (3): "if/else" (condicional), "while" (de repetição), "for" (de repetição).
# Variáveis (22): "opc" - str, "recomend" - dict(str), "respostas" - dict(str), "nomes" - dict(str), "idades" - dict(str), "generos" - dict(str), "cidadaos" - tuple(dict), "quantidade_cid" - int, "total" - int, "saudacoes" - list(str), "despedidas" - list(str), "sintomas" - dict(str), "cumprimentos" - tuple(list), "perguntas" - dict(str), "quantidade_perg" - int, "id" - list(str), "pes" - dict(str), "login" - dict, "senha" - dict, "autuser" - tuple(dict), "login" - dict(str), "senha" - dict(str).
