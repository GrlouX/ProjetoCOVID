...
# Linhas válidas de código da biblioteca de back-end 01: 133
...
# Variáveis (38): "cump" - tuple(list), "i" - int, "j" - int, "k" - int, "qte" - str/int, "qte_aux" - str, "elem" - str, "lista" - list(str), "result" - tipo str , "res" - str, "tot" - str/int, "tot_aux" - str, "char" - str, "resp" - list(str), "bat" - list(str), "respostas" - list(str), "cidadaos" - list(str), "cpf" - list(str), "cpf_aux" - list(str), "nome" - str, "nome_aux" - str, "idade" - str/int, "idade_aux" - str, "sexo" - str, "sexo_aux" - str, "sexo_bin" - str, "cid" - tuple(list), "c" - int, "p" - int, "arq" - list(str), "listr" - list(list), "l" - list, "rg" - str, "cpf0" - str, "usu" - dict, "login" - str, "senha" - str, "adm" - str, "ger" - str, "tipo" - str, "ind" - int.
