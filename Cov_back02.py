...
# Linhas válidas de código da biblioteca de back-end 02: 62
...
# Variáveis (10): "resp" - dict(dict(str)), "r" - str, "i" - int, "k" - int, "result" - dict(dict(str)), "bat" - dict(str), "elem" - list, "part" - list, "item" - str, "cid" - tuple(dict(str)), "lista" - list(str).
